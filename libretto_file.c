...
void ins_corso() {
    ...
    f_pointer=fopen("/Users/matteo/Documents/perfile/db_corsi.dat","a+");
    printf("\nStai inserendo un nuovo corso\n");
    printf("Inserisci nome corso: \n");
    fgets(corso.nome_corso,DIM_NOME,stdin);
...
void vis_corsi() {
    struct insegnamento corso;
    int n;
    f_pointer=fopen("/Users/matteo/Documents/perfile/db_corsi.dat","r");
