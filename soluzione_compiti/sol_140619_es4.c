...
specifica funzione, di inserire in due arrays N
numeri interi (gli arrays avranno la stessa lunghezza, N).
Il programma dovrà visualizzare i due arrays tramite la chiamata
ad una specifica funzione.
Infine, il programma dovrà creare una lista concatenata lineare - di dimensione
pari alla lunghezza degli arrays - i cui elementi contengano due numeri interi.
...
intero assumerà il valore 1 se i corrispondenti valori degli arrays sono uguali
